...
CThreadDefinitions::CThreadDefinitions() {
...
long CThreadDefinitions::ReadFromFile(unsigned long ulToken, long lFileHandle){
...
long CThreadDefinitions::WriteToFile(unsigned long *ulToken, long *lFileHandle){
...
void CThreadDefinitions::Run(){


}


void CThreadDefinitions::Terminate(){


}

char* CThreadDefinitions::ini_buffer_reader(char* str, int num, void* stream)
{
...
int CThreadDefinitions::handler(void* user, const char* section, const char* name,
                   const char* value)
{
...
int CThreadDefinitions::parseFile()
{
...
int CThreadDefinitions::outputFile()
{
